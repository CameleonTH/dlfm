...
static wxChar* const SArgumentMissing = wxT("Missing argument in format \"%s\"");
...
static wxChar* const SCannotCreateEmptyDir = wxT("Cannot create empty directory");
...
static wxChar* const SErrInvalidDateMonthWeek = wxT("Year %d, month %d, Week %d and day %d is not a valid date.");
static wxChar* const SErrInvalidDateWeek = wxT("%d %d %d is not a valid dateweek");
static wxChar* const SErrInvalidDayOfWeek = wxT("%d is not a valid day of the week");
static wxChar* const SErrInvalidDayOfWeekInMonth = wxT("Year %d Month %d NDow %d DOW %d is not a valid date");
static wxChar* const SErrInvalidDayOfYear = wxT("Year %d does not have a day number %d");
static wxChar* const SErrInvalidTimeStamp = wxT("Invalid date/timestamp : \"%s\"");
...
static wxChar* const SInvalidArgIndex = wxT("Invalid argument index in format \"%s\"");
...
static wxChar* const SInvalidDateTime = wxT("%f is not a valid date/time value.");
...
static wxChar* const SInvalidVarOpWithHResultWithPrefix = wxT("Invalid variant operation (%s%.8x) %s");
static wxChar * const SNoError = wxT("No error.");
static wxChar* const SNoThreadSupport = wxT("Threads not supported. Recompile program with thread driver.");
...
static wxChar* const SUnKnownRunTimeError = wxT("Unknown Run-Time error : %3.3d");
...
static wxChar* const SVarTypeAlreadyUsedWithPrefix = wxT("Custom variant type (%s%.4x) already used by %s");
static wxChar* const SVarTypeConvertOverflow = wxT("Overflow while converting variant of type (%s) into type (%s)");
static wxChar* const SVarTypeCouldNotConvert = wxT("Could not convert variant of type (%s) into type (%s)");
static wxChar* const SVarTypeNotUsableWithPrefix = wxT("Custom variant type (%s%.4x) is not usable");
static wxChar* const SVarTypeOutOfRangeWithPrefix = wxT("Custom variant type (%s%.4x) is out of range");
static wxChar* const SVarTypeRangeCheck1 = wxT("Range check error for variant of type (%s)");
static wxChar* const SVarTypeRangeCheck2 = wxT("Range check error while converting variant of type (%s) into type (%s)");
static wxChar* const SVarTypeTooManyCustom = wxT("Too many custom variant types have been registered");
static wxChar* const SVarUnexpected = wxT("Unexpected variant error");

static wxChar* const SFallbackError = wxT("An error, whose error code is larger than can be returned to the OS, has occured");

static wxChar* const SNoToolserver = wxT("Toolserver is not installed, cannot execute Tool");
